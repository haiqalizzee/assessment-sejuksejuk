    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-cyan-100 flex items-center justify-center px-4">
      <Card className="w-full max-w-md border-0 shadow-2xl bg-white/95 backdrop-blur-sm">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-xl font-bold text-red-900">Firebase Configuration Error</CardTitle>
          <CardDescription className="text-red-600">
            Firebase has not been properly configured for this application.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="bg-red-50 p-4 rounded-lg text-sm">
            <p className="font-semibold text-red-900 mb-2">To fix this issue:</p>
